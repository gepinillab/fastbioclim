...
A single-layer \`SpatRaster\` with the minimum temperature, named
"bio06".

## Details

This function calculates bio06 following the standard definition used by
WorldClim (Hijmans et al., 2005; O'Donnell & Ignizio, 2012) and ANUCLIM
6.1 (Xu & Hutchinson, 2013), which is the single lowest value from all
