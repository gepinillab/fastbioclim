...
Internal function to calculate custom summary statistics using \`terra\`
functions. Designed for datasets that fit into RAM.
...
- ...:
  ...
  Other arguments including inter_variable, period_length, circular,
