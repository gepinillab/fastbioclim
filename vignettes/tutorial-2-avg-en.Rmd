...
1.  `calculate_average()`: Calculates a **long-term climatological average**. It answers the question: *"What is the average maximum temperature for all Januaries in my time series?"*.
...
## 3. Long-term Climatological Averages with `calculate_average()`
