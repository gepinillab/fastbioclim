...
¡Listo! `tmax_avg_longterm` contiene la climatología de 30 años. La primera capa es el promedio de todos los eneros, la segunda de todos los febreros, etc.
...
Si utilizas **fastbioclim** en tu investigación, por favor cita nuestro *Software Note*:
...
Para obtener el formato de cita más actualizado desde R, siempre puedes usar:
