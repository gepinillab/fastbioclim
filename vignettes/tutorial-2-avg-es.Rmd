...
vignette: >
  %\VignetteIndexEntry{Cálculo de Promedios Temporales con fastbioclim}
...
# Usaremos solo un núcleo en este ejemplo.
future::plan("sequential")

# Habilitar las barras de progreso globales para ver el avance
